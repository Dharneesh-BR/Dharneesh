    ...
    <section className="relative w-full overflow-hidden" style={{ backgroundColor: '#fbfaf9' }}>
      ...
      >
        {!videoFailed ? (
          ...
          /* Fallback: Text on White Background */
          <motion.div 
            className="absolute inset-0 flex items-center justify-center text-center px-6 bg-white"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="max-w-4xl">
              <motion.h1 
                className="text-4xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight tracking-wide"
                variants={itemVariants}
              >
                <motion.span
                  variants={itemVariants}
